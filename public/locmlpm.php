                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item" aria-current="page">
                                        <a href="../public/locmlpl.php">Localidad Pa&iacute;s</a>
                                    </li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Localidad Pa&iacute;s</h4>
                                <form id="form" data-parsley-validate class="m-t-30" method="post" action="../class/locmlpa.php">
                                    ...
                                    <div class="form-group">
                                        <label for="paisEstado">Estado</label>
                                		<select id="paisEstado" name="paisEstado" class="select2 form-control custom-select" style="width: 100%; height:36px;" <?php echo $workReadonly; ?>>
                                    ...
                                    <div class="form-group">
                                        <label for="paisNombre">Pa&iacute;s</label>
                                        <input id="paisNombre" name="paisNombre" class="form-control" type="text" placeholder="Nombre" value="<?php echo $row_03; ?>" required <?php echo $workReadonly; ?>>
                                    </div>
                                    <div class="form-group">
                                    	<label for="paisDescripcion">Descripci&oacute;n</label>
                                    	<textarea id="paisDescripcion" name="paisDescripcion" class="form-control" rows="5" <?php echo $workReadonly; ?>><?php echo $row_04; ?></textarea>
                                	</div>
                                    <button type="submit" class="btn <?php echo $workAStyle; ?>" <?php echo $workReadonly; ?>><?php echo $workATitulo; ?></button>
                                    <a role="button" class="btn btn-dark" href="../public/locmlpl.php">Volver</a>
                                </form>
                            </div>
                        </div>
                    </div>
